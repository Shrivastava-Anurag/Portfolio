...
function Skills() {
    ...
    return(
        <>
        <div className='mx-10 mt-0 mb-0 md:my-20 flex flex-col md:mb-[700px] lg:mb-[600px]'>

            <StaggeredText text='SKILLS' />

            <div className='md:hidden flex flex-wrap min-[425px]:mx-10 min-[510px]:mx-20 min-[570px]:mx-0 sm:flex-wrap lg:flex-row justify-around mt-20'>
            {skills.map((skill) => (
